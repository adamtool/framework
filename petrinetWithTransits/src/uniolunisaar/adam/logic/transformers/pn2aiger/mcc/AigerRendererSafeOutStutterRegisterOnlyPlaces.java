 ...
 */
public class AigerRendererSafeOutStutterRegisterOnlyPlaces extends AigerRendererSafeOutStutterRegister {

    public AigerRendererSafeOutStutterRegisterOnlyPlaces(PetriNet net, boolean max) {
        super(net, max);
    }
